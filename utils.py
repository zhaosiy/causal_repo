...
def load_data(rootdir, batch_size=1, suffix=''):
    ...
    loc_train = np.load(os.path.join(rootdir, suffix, 'loc_train_final.npy'))
    vel_train = np.load(os.path.join(rootdir, suffix, 'vel_train_final.npy'))
    edges_train = np.load(os.path.join(rootdir, suffix, 'edges_train_final.npy'))

    loc_valid = np.load(os.path.join(rootdir, suffix, 'loc_valid_final.npy'))
    vel_valid = np.load(os.path.join(rootdir, suffix, 'vel_valid_final.npy'))
    edges_valid = np.load(os.path.join(rootdir, suffix, 'edges_valid_final.npy'))

    loc_test = np.load(os.path.join(rootdir, suffix, 'loc_test_final.npy'))
    vel_test = np.load(os.path.join(rootdir, suffix, 'vel_test_final.npy'))
    edges_test = np.load(os.path.join(rootdir, suffix, 'edges_test_final.npy'))
...
def nll_gaussian(preds, target, variance, add_const=False):
    print(preds.shape, target.shape,' prem target')
